export interface paths {
		...
		get: {
			...
			responses: {
				200: {
					...
					content: {
						"application/json": components["schemas"]["SuccessSchema"] & {
							data: {
								/**
								 * @description The status for this key
								 * @enum {string}
								 */
								status: "active" | "revoked";
								/** @description The name of the for this key */
								name: string;
								plan: {
									/** @description The name of the plan */
									name: string;
									/** @description The rate limit per minute for this plan */
				...
				"4xx": {
					...
					content: {
						"application/json": components["schemas"]["FailureSchema"];
					};
				};
				"5xx": {
					headers: {
				...
				200: {
					...
					content: {
						"application/json": components["schemas"]["SuccessSchema"] & {
							...
							data: components["schemas"]["AISongTaskOutput"][];
						};
					};
				};
				"4xx": {
	...
	"/elevenlabs/clone_voice": {
		 ...
		 *
		 *     Users can clone voices up to their plan limits per-day. Cloned voices can be used in subsequent text-to-speech requests.
		 */
		post: {
			parameters: {
				query?: never;
		...
		post: {
			...
			responses: {
				200: {
					...
					content: {
						"application/json": components["schemas"]["SuccessSchema"] & {
							data: components["schemas"]["ElevenLabsInferenceOutput"];
						};
					};
				};
				"4xx": {
...
export interface components {
	schemas: {
		 ...
		 * @description Representing a successful response.
		 */
		SuccessSchema: {
			/**
			 * Success indicator
			 * @description Indicates that the response represents a successful operation.
			 * @enum {boolean}
			 */
			ok: true;
			/**
			 * Response code
			 * @description The numeric code representing the success status.
			 */
			code: number;
			/**
			 * Response message
			 * @description A human-readable message providing additional information.
			 */
			message: string;
			/**
			 * Response data
			 * @description The data field contains the successful response payload.
			 */
			data: unknown;
			/**
			 * No errors on success responses
			 * @description The errors field is always null for success responses.
			 */
			errors: null;
			/**
			 * Metadata
			 * @description The meta field contains additional metadata related to the response.
			 * @default {}
			 */
			meta: {
				[key: string]: unknown;
		 ...
		 * @description Representing a failed response.
		 */
		FailureSchema: {
			/**
			 * Failure indicator
			 * @description Indicates that the response represents a failed operation.
			 * @enum {boolean}
			 */
			ok: false;
			/**
			 * Response code
			 * @description The numeric code representing the failure status.
			 */
			code: number;
			/**
			 * Response message
			...
			message: string;
			/**
			 * No data on failure responses
			 * @description The data field is always null for failure responses.
			 */
			data: null;
			/**
			 * Error details
			 * @description The errors field contains details about the failure. It is optional and may be omitted if no additional error information is provided.
			 * @default {}
			 */
			errors: {
				[key: string]: unknown;
